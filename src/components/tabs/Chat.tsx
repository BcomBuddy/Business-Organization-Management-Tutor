...
const Chat: React.FC = () => {
  ...
  const exportSelectedMessages = () => {
    ...
    a.href = url;
    a.download = `biztutor-selected-messages-${new Date().toISOString().split('T')[0]}.json`;
  ...
  const exportConversation = () => {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `biztutor-conversation-${new Date().toISOString().split('T')[0]}.json`;
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);
    URL.revokeObjectURL(url);
...
Practice Question: You notice declining productivity in your team. Using motivation theories, develop a comprehensive plan to re-engage your employees and improve performance.`;
      ...
      response = `Business Organization & Management

I'm BizTutor, your AI assistant for Business Organization & Management topics. I can help you understand key concepts in:
...
• Controlling - Monitoring and corrective action

Business Organization Topics:
...
Feel free to ask specific questions about any B.O.M. topic, and I'll provide structured explanations with examples!

Key Takeaways:
• B.O.M. covers both theoretical foundations and practical applications
• Understanding core functions helps in effective management
• Real-world examples make concepts more applicable

Practice Question: Compare and contrast the advantages and disadvantages of a partnership versus a private limited company for a small business expansion.`;
    }
          ...
          {filteredMessages.length === 0 && chatMessages.length === 0 && (
            <div className="text-center py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
                {[
                  { text: "Explain planning in management", icon: Target, color: "from-blue-500 to-blue-600" },
                  { text: "What is delegation?", icon: Users, color: "from-green-500 to-green-600" },
                  { text: "Types of business organizations", icon: Building, color: "from-purple-500 to-purple-600" },
                  { text: "Leadership styles", icon: Award, color: "from-orange-500 to-orange-600" },
                  { text: "MBO principles", icon: BookOpen, color: "from-indigo-500 to-indigo-600" },
                  { text: "Control process steps", icon: BarChart3, color: "from-pink-500 to-pink-600" }
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 shadow-sm">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-600 dark:text-gray-300 text-sm">
                    {isRetrying ? 'Retrying...' : 'BizTutor is thinking...'}
                  </span>
                </div>
              </div>
            </div>
